...
const actions = {
  change:
    (value?: string): Action<State, ContainerProps> =>
...
export const ThemeContainer: ContainerComponent<ContainerProps> =
...
export const ThemeSubscriber: SubscriberComponent<State, Actions> =
